...
static void setup_iomux_pfe(int intf0, int intf1, int intf2)
{
	...
	case PHY_INTERFACE_MODE_RGMII:
		...
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT1,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PF2));

		/* set PF1 - MSCR[81] - for PFE MAC0 MDO*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_S32_G1_PFE_IN
		       | SIUL2_MSCR_MUX_MODE_ALT1,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE15));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC0_MDO_IN));

		/* set PC3 - MSCR[35] - for PFE MAC0 PPS0*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT3,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PJ7));

		/* set PH6 - MSCR[118] - for PFE MAC0 RXD0*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH6));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC0_RXD0_IN));

		/* set PH7 - MSCR[119] - for PFE MAC0 RXD1*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH7));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC0_RXD1_IN));

		/* set PH8 - MSCR[120] - for PFE MAC0 RXD2*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH8));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC0_RXD2_IN));

		/* set PH9 - MSCR[121] - for PFE MAC0 RXD3*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH9));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC0_RXD3_IN));

		/* set PH5 - MSCR[117] - for PFE MAC0 RXDV*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH5));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC0_RXDV_IN));

		/* set PH4 - MSCR[116] - for PFE MAC0 RX CLK*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH4));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC0_RX_CLK_IN));

		/* set PJ0 - MSCR[144] - for PFE MAC0 TXD0*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT1,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PJ0));

		/* set PH1 - MSCR[113] - for PFE MAC0 TXD1*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT1,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH1));

		/* set PH2 - MSCR[114] - for PFE MAC0 TXD2*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT1,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH2));

		/* set PH3 - MSCR[115] - for PFE MAC0 TXD3*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT1,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH3));

		/* set PH10 - MSCR[122] - for PFE MAC0 TX CLK*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PH10));

		/* set PE14 - MSCR[78] - for PFE MAC0 TX EN*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT1,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE14));
		break;
	...
	case PHY_INTERFACE_MODE_RGMII:
		...
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PD12));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_MDC_IN));

		/* set PD13 - MSCR[61] - for PFE MAC1 MDO*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_S32_G1_PFE_IN
		       | SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PD13));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_MDI_IN));

		/* set PE10 - MSCR[74] - for PFE MAC1 RXD0*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE10));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_RXD0_IN));

		/* set PE11 - MSCR[75] - for PFE MAC1 RXD1*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE11));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_RXD1_IN));

		/* set PE12 - MSCR[76] - for PFE MAC1 RXD2*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE12));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_RXD2_IN));

		/* set PE13 - MSCR[77] - for PFE MAC1 RXD3*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE13));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_RXD3_IN));

		/* set PE9 - MSCR[73] - for PFE MAC1 RXDV*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE9));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_RXDV_IN));

		/* set PE8 - MSCR[72] - for PFE MAC1 RX CLK*/
		writel(SIUL2_MSCR_S32_G1_PFE_IN,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE8));
		writel(SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PFE_MAC1_RX_CLK_IN));

		/* set PE4 - MSCR[68] - for PFE MAC1 TXD0*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE4));

		/* set PE5 - MSCR[69] - for PFE MAC1 TXD1*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE5));

		/* set PE6 - MSCR[70] - for PFE MAC1 TXD2*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE6));

		/* set PE7 - MSCR[71] - for PFE MAC1 TXD3*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT3,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE7));

		/* set PE2 - MSCR[66] - for PFE MAC1 TX CLK*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE2));

		/* set PE3 - MSCR[67] - for PFE MAC1 TX EN*/
		writel(SIUL2_MSCR_S32_G1_PFE_OUT | SIUL2_MSCR_MUX_MODE_ALT2,
		       SIUL2_X_MSCRn(SIUL2_MSCR_S32_G1_PE3));
