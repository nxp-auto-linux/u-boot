...
#if defined(TARGET_OS_QNX) || defined(TARGET_OS_LINUX) || defined(TARGET_OS_AUTOSAR) || defined(TARGET_OS_UBOOT)
...
/*
 * Note: compiler behaviour check was removed.
 * But the only verified variant is gcc 6.3.1 on aarch64
 */
