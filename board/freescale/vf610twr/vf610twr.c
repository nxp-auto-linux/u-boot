...
void setup_iomux_nfc(void)
{
	static const iomux_v3_cfg_t nfc_pads[] = {
		NEW_PAD_CTRL(VF610_PAD_PTD31__NFC_IO15,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD30__NFC_IO14,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD29__NFC_IO13,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD28__NFC_IO12,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD27__NFC_IO11,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD26__NFC_IO10,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD25__NFC_IO9,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD24__NFC_IO8,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD23__NFC_IO7,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD22__NFC_IO6,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD21__NFC_IO5,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD20__NFC_IO4,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD19__NFC_IO3,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD18__NFC_IO2,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD17__NFC_IO1,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTD16__NFC_IO0,VF610_NFC_IO_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTB24__NFC_WEB,VF610_NFC_SIG_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTB25__NFC_CE0B,VF610_NFC_SIG_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTB27__NFC_REB,VF610_NFC_SIG_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTC26__NFC_RBB,VF610_NFC_SIG_RB_PAD_CTRL), // Ready/Busy is an input signal with xtal PULLUP
		NEW_PAD_CTRL(VF610_PAD_PTC27__NFC_ALE,VF610_NFC_SIG_PAD_CTRL),
		NEW_PAD_CTRL(VF610_PAD_PTC28__NFC_CLE,VF610_NFC_SIG_PAD_CTRL),
	};
