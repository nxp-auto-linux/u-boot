...
#if (defined(CONFIG_FSL_DSPI) && !defined(CONFIG_TARGET_TYPE_EMULATOR))
static void setup_iomux_dspi(void)
{
	/* Configure Chip Select Pins */
	writel(SUIL2_MSCR_S32R45_PAD_CTL_SPI5_CS0,
	       SIUL2_MSCRn(SIUL2_MSCR_S32R45_PA_10));

	/* MSCR */
	writel(SIUL2_MSCR_S32R45_PAD_CTL_SPI5_SOUT,
	       SIUL2_MSCRn(SIUL2_MSCR_S32R45_PJ_5));

	writel(SIUL2_MSCR_S32R45_PAD_CTL_SPI5_SIN,
	       SIUL2_MSCRn(SIUL2_MSCR_S32R45_PJ_4));

	writel(SIUL2_MSCR_S32R45_PAD_CTL_SPI5_SCK,
	       SIUL2_MSCRn(SIUL2_MSCR_S32R45_PA_9));

	/* IMCR */
	writel(SIUL2_IMCR_S32R45_PAD_CTL_SPI5_SIN,
	       SIUL2_IMCRn(SIUL2_PJ_4_IMCR_S32R45_SPI5_SIN));
}
#endif
