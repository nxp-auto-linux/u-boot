...
static void setup_sys_clocks( void )
{
	...
	/* set PLL0 (ARM-PLL DFS1) as SYSCLK */
...
{
	/* PIT0 */
	writeb( MC_ME_PCTLn_RUNPCm(0), MC_ME_PCTL22 );
	/* PIT1 */
	writeb( MC_ME_PCTLn_RUNPCm(0), MC_ME_PCTL85 );
	/* LINFLEXD0 */
	writeb( MC_ME_PCTLn_RUNPCm(0), MC_ME_PCTL42 );
	/* LINFLEX1 */
	writeb( MC_ME_PCTLn_RUNPCm(0), MC_ME_PCTL89 );
	/* ENET */
	writeb( MC_ME_PCTLn_RUNPCm(0), MC_ME_PCTL50 );
	/* USDHC */
	writeb( MC_ME_PCTLn_RUNPCm(0), MC_ME_PCTL18 );
