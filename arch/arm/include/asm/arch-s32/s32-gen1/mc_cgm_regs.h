...
#define PERIPH_PLL_PHI5_FREQ		(12500000)
#define PERIPH_PLL_PHI6_FREQ		(10000000)
#define PERIPH_PLL_PHI_Nr		(7)
...
#define DDR_PLL_PHI0_FREQ		(80000000)
...
#define AURORA_PLL_PHI0_FREQ		(500000000)
