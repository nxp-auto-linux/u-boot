...
#define PCIE_SS_BASEADDRESS(dbi_base) \
	((uint64_t)(dbi_base) + PCIE_DBI_SS_OFFSET)

/* PCIe PHY General Control */

#define PCIE_SS_PCIE_PHY_GEN_CTRL(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0x0)

/* PCIe PHY MPLLA Control */

#define PCIE_SS_PCIE_PHY_MPLLA_CTRL(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0x10)

/* Subsystem Read Write Register 0 */

#define PCIE_SS_SS_RW_REG_0(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0xF0)

/* Subsystem Read Write Register 1 */

#define PCIE_SS_SS_RW_REG_1(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0xF4)

/* PCIe Controller 0 General Control 1 */

#define PCIE_SS_PE0_GEN_CTRL_1(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0x1050)

/* PCIe Controller 0 Link Debug 1 */

#define PCIE_SS_PE0_LINK_DBG_1(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0x10B0)

/* PCIe Controller 0 Link Debug 2 */

#define PCIE_SS_PE0_LINK_DBG_2(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0x10B4)

/* PHY Register Address Register */

#define PCIE_SS_PHY_REG_ADDR(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0x3008)

/* PHY Register Data Register */

#define PCIE_SS_PHY_REG_DATA(dbi_base) \
	(PCIE_SS_BASEADDRESS(dbi_base) + 0x300C)
...
#define PCIE_SS_RATE_VALUE(x)          (((x) & 0x00000003) << 8)
#define PCIE_SS_RATE_MSB               (9)
#define PCIE_SS_RATE_LSB               (8)
#define PCIE_SS_RATE_MASK              (0x00000003)
#define PCIE_SS_RATE                   ((PCIE_SS_RATE_MASK) << \
		(PCIE_SS_RATE_LSB))
