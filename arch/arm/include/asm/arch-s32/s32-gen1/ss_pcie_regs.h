...
#ifndef PCIE_SS_BASEADDRESS
#define PCIE_SS_BASEADDRESS            0x40400000
#endif

/* Instance TYPE1 */

#ifndef PCIE_BASEADDRESS
#define PCIE_BASEADDRESS PCIE_SS_BASEADDRESS
#endif

/* Status and Command Register. */

#define PCIE_CTRL_TYPE1_STATUS_COMMAND_REG (PCIE_CTRL_BASEADDRESS + 0x4)

/* Class Code and Revision ID Register. */

#define PCIE_CTRL_TYPE1_CLASS_CODE_REV_ID_REG (PCIE_CTRL_BASEADDRESS + 0x8)
...
#define PCIE_SPCIE_CAP_HEADER_BASEADDRESS (PCIE_CTRL_BASEADDRESS + 0x148)
...
#define PCIE_CAP_BASEADDRESS (PCIE_CTRL_BASEADDRESS + 0x0070)
...
#define PCIE_IATU_BASEADDRESS (PCIE_SS_BASEADDRESS + 0x60000)
...
#define PCIE_PORT_LOGIC_BASEADDRESS (PCIE_CTRL_BASEADDRESS + 0x0700)

/* Port Force Link Register. */

#define PCIE_PORT_LOGIC_PORT_FORCE_OFF (PCIE_PORT_LOGIC_BASEADDRESS + 0x8)

/* Port Link Control Register. */

#define PCIE_PORT_LOGIC_PORT_LINK_CTRL_OFF (PCIE_PORT_LOGIC_BASEADDRESS + 0x10)

/* Timer Control and Max Function Number Register. */

#define PCIE_PORT_LOGIC_TIMER_CTRL_MAX_FUNC_NUM_OFF \
		(PCIE_PORT_LOGIC_BASEADDRESS + 0x18)

/* Link Width and Speed Change Control Register. */

#define PCIE_PORT_LOGIC_GEN2_CTRL_OFF \
		(PCIE_PORT_LOGIC_BASEADDRESS + 0x10C)

/* Gen3 Control Register. */

#define PCIE_PORT_LOGIC_GEN3_RELATED_OFF (PCIE_PORT_LOGIC_BASEADDRESS + 0x190)

/* Gen3 EQ Control Register. */

#define PCIE_PORT_LOGIC_GEN3_EQ_CONTROL_OFF \
		(PCIE_PORT_LOGIC_BASEADDRESS + 0x1A8)

/* DBI Read-Only Write Enable Register. */

#define PCIE_PORT_LOGIC_MISC_CONTROL_1_OFF \
		(PCIE_PORT_LOGIC_BASEADDRESS + 0x1BC)

/* ACE Cache Coherency Control Register 3 */

#define PCIE_PORT_LOGIC_COHERENCY_CONTROL_3_OFF \
		(PCIE_PORT_LOGIC_BASEADDRESS + 0x1E8)

/* Field definitions for PORT_FORCE_OFF */
...
/* Field definitions for PORT_LINK_CTRL_OFF */
...
/* Field definitions for TIMER_CTRL_MAX_FUNC_NUM_OFF */
...
/* Field definitions for GEN2_CTRL_OFF */
...
/* Field definitions for GEN3_EQ_CONTROL_OFF */
...
/* Field definitions for MISC_CONTROL_1_OFF */
...
/* Field definitions for COHERENCY_CONTROL_3_OFF */
...
#define PCIE_SS_PCIE_PHY_GEN_CTRL      (PCIE_SS_BASEADDRESS + 0x00080000)

/* PCIe PHY MPLLA Control */

#define PCIE_SS_PCIE_PHY_MPLLA_CTRL    (PCIE_SS_BASEADDRESS + 0x00080010)

/* Subsystem Read Write Register 0 */

#define PCIE_SS_SS_RW_REG_0            (PCIE_SS_BASEADDRESS + 0x000800F0)

/* Subsystem Read Write Register 1 */

#define PCIE_SS_SS_RW_REG_1            (PCIE_SS_BASEADDRESS + 0x000800F4)

/* PCIe Controller 0 General Control 1 */

#define PCIE_SS_PE0_GEN_CTRL_1         (PCIE_SS_BASEADDRESS + 0x00081050)

/* PCIe Controller 0 Link Debug 1 */

#define PCIE_SS_PE0_LINK_DBG_1         (PCIE_SS_BASEADDRESS + 0x000810B0)

/* PCIe Controller 0 Link Debug 2 */

#define PCIE_SS_PE0_LINK_DBG_2         (PCIE_SS_BASEADDRESS + 0x000810B4)

/* PHY Register Address Register */

#define PCIE_SS_PHY_REG_ADDR           (PCIE_SS_BASEADDRESS + 0x00083008)

/* PHY Register Data Register */

#define PCIE_SS_PHY_REG_DATA           (PCIE_SS_BASEADDRESS + 0x0008300C)
