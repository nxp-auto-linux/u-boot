...
#define PLLDIG_PLLDV_RFDPHI1_MAXVALUE	(0x7E)
...
#define DFS_PORTRESET_PORTRESET_MASK		(0xF0000000)
#define DFS_PORTRESET_PORTRESET_OFFSET		(28)

/* DFS Divide Register Portn (DFS_DVPORTn) */
#define DFS_DVPORTn(pll,n)				(DFS0_BASE_ADDR + ((pll) * 0x80) + (0x00000018 + (((n) + 1) * 0x8)))
...
#define ARM_PLL_PHI1_DFS1_FREQ			(1000000000)
#define ARM_PLL_PHI1_DFS2_FREQ			(1000000000)
#define ARM_PLL_PHI1_DFS3_FREQ			(1000000000)
#define ARM_PLL_PHI1_DFS4_FREQ			(1000000000)
#define ARM_PLL_PHI1_DFS_Nr				(4)
#define ARM_PLL_PLLDV_PREDIV			(2)
#define ARM_PLL_PLLDV_MFD				(50)
#define ARM_PLL_PLLDV_MFN				(0)

#define PERIPH_PLL_PHI0_FREQ			(1200000000)
#define PERIPH_PLL_PHI1_FREQ			(1200000000)
...
#define ENET_PLL_PHI1_DFS1_FREQ			(1000000000)
#define ENET_PLL_PHI1_DFS2_FREQ			(1000000000)
#define ENET_PLL_PHI1_DFS3_FREQ			(1000000000)
#define ENET_PLL_PHI1_DFS4_FREQ			(1000000000)
#define ENET_PLL_PHI1_DFS_Nr			(4)
#define ENET_PLL_PLLDV_PREDIV			(2)
#define ENET_PLL_PLLDV_MFD				(50)
#define ENET_PLL_PLLDV_MFN				(0)

#define DDR_PLL_PHI0_FREQ				(1066000000)
#define DDR_PLL_PHI1_FREQ				(1066000000)
#define DDR_PLL_PHI1_DFS1_FREQ			(1066000000)
#define DDR_PLL_PHI1_DFS2_FREQ			(1066000000)
#define DDR_PLL_PHI1_DFS3_FREQ			(1066000000)
#define DDR_PLL_PHI1_DFS4_FREQ			(1066000000)
#define DDR_PLL_PHI1_DFS_Nr				(4)
#define DDR_PLL_PLLDV_PREDIV			(2)
#define DDR_PLL_PLLDV_MFD				(53)
#define DDR_PLL_PLLDV_MFN				(0)

#define VIDEO_PLL_PHI0_FREQ				(1200000000)
