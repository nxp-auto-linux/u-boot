...
/* AIPS 1 */
#define SEMA42_BASE_ADDR        (AIPS0_BASE_ADDR + 0x00003000)
#define MSCM_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00005000)
#define SWT0_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00008000)
#define SWT1_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00009000)
#define SWT2_BASE_ADDR          (AIPS0_BASE_ADDR + 0x0000A000)
#define STM0_BASE_ADDR          (AIPS0_BASE_ADDR + 0x0000C000)
#define STM1_BASE_ADDR          (AIPS0_BASE_ADDR + 0x0000D000)
#define DMA0_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00010000)
#define DMA0_TCD_BASE_ADDR      (AIPS0_BASE_ADDR + 0x00011000)
#define DMA1_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00012000)
#define DMA1_TCD_BASE_ADDR      (AIPS0_BASE_ADDR + 0x00013000)
#define XRDC_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00014000)
#define CSE_BASE_ADDR           (AIPS0_BASE_ADDR + 0x00018000)
#define DMA_MUX0_BASE_ADDR      (AIPS0_BASE_ADDR + 0x00021000)
#define I2C0_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00022000)
#define I2C1_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00023000)
#define FTM0_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00024000)
#define FTM1_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00025000)
#define FTM2_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00026000)
#define FTM3_BASE_ADDR          (AIPS0_BASE_ADDR + 0x00027000)
#define DSPI0_BASE_ADDR         (AIPS0_BASE_ADDR + 0x00033000)
#define DSPI1_BASE_ADDR         (AIPS0_BASE_ADDR + 0x00034000)
#define DSPI2_BASE_ADDR         (AIPS0_BASE_ADDR + 0x00035000)
#define DSPI3_BASE_ADDR         (AIPS0_BASE_ADDR + 0x00036000)
#define DSPI4_BASE_ADDR         (AIPS0_BASE_ADDR + 0x00037000)
#define UART0_BASE_ADDR         (AIPS0_BASE_ADDR + 0x00038000)
#define UART1_BASE_ADDR         (AIPS0_BASE_ADDR + 0x00039000)
#define UART2_BASE_ADDR         (AIPS0_BASE_ADDR + 0x0003A000)
#define FLEXCAN1_BASE_ADDR      (AIPS0_BASE_ADDR + 0x0003C000)
#define FLEXCAN2_BASE_ADDR      (AIPS0_BASE_ADDR + 0x0003D000)
#define ADC_BASE_ADDR           (AIPS0_BASE_ADDR + 0x0003E000)
#define PIT_BASE_ADDR           (AIPS0_BASE_ADDR + 0x00044000)
#define MC_RGM0_BASE_ADDR       (AIPS0_BASE_ADDR + 0x00050000)
#define MC_RGM1_BASE_ADDR       (AIPS0_BASE_ADDR + 0x00052000)
#define MC_RGM2_BASE_ADDR       (AIPS0_BASE_ADDR + 0x00053000)
#define MC_CGM0_BASE_ADDR       (AIPS0_BASE_ADDR + 0x00054000)
#define MC_CGM1_BASE_ADDR       (AIPS0_BASE_ADDR + 0x00056000)
#define MC_CGM2_BASE_ADDR       (AIPS0_BASE_ADDR + 0x00057000)
#define MC_ME0_BASE_ADDR        (AIPS0_BASE_ADDR + 0x00058000)
#define MC_ME1_BASE_ADDR        (AIPS0_BASE_ADDR + 0x0005A000)
#define MC_ME2_BASE_ADDR        (AIPS0_BASE_ADDR + 0x0005B000)
#define SIUL2_BASE_ADDR         (AIPS0_BASE_ADDR + 0x0005C000)
#define SSCM0_BASE_ADDR         (AIPS0_BASE_ADDR + 0x0006C000)
#define SSCM1_BASE_ADDR         (AIPS0_BASE_ADDR + 0x0006D000)
#define SSCM2_BASE_ADDR         (AIPS0_BASE_ADDR + 0x0006E000)
#define FLEXCAN0_BASE_ADDR      (AIPS0_BASE_ADDR + 0x0007F000)
