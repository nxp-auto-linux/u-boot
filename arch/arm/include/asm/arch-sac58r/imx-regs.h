...
#define DMA_CH_MUX0_BASE_ADDR	(AIPS0_BASE_ADDR + 0x0004C000)
#define DMA_CH_MUX1_BASE_ADDR	(AIPS0_BASE_ADDR + 0x0004D000)
...
#define DMA_CH_MUX2_BASE_ADDR	(AIPS2_BASE_ADDR + 0x00067000)
#define DMA_CH_MUX3_BASE_ADDR	(AIPS2_BASE_ADDR + 0x00068000)
