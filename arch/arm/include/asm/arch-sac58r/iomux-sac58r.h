...
#define RAYLEIGH_UART_PAD_CTRL	(PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_MED | \
			PAD_CTL_DSE_25ohm | PAD_CTL_OBE_IBE_ENABLE)
#define RAYLEIGH_SDHC_PAD_CTRL	(PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_HIGH | \
			PAD_CTL_DSE_20ohm | PAD_CTL_OBE_IBE_ENABLE)
#define RAYLEIGH_ENET_PAD_CTRL (PAD_CTL_PUS_47K_UP | PAD_CTL_SPEED_HIGH | \
			PAD_CTL_DSE_50ohm | PAD_CTL_OBE_IBE_ENABLE)
#define RAYLEIGH_DDR_PAD_CTRL	PAD_CTL_DSE_25ohm
#define RAYLEIGH_I2C_PAD_CTRL	(PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_50ohm | \
				PAD_CTL_SPEED_HIGH | PAD_CTL_OBE_IBE_ENABLE)
#define RAYLEIGH_NFC_IO_PAD_CTRL (PAD_CTL_SPEED_HIGH | PAD_CTL_SRE | \
				PAD_CTL_DSE_50ohm | PAD_CTL_PUS_47K_UP | PAD_CTL_OBE_IBE_ENABLE)
#define RAYLEIGH_NFC_SIG_PAD_CTRL	(PAD_CTL_SPEED_HIGH | PAD_CTL_SRE | \
				PAD_CTL_DSE_50ohm | PAD_CTL_PUS_47K_UP | PAD_CTL_OBE_ENABLE)
#define RAYLEIGH_NFC_SIG_RB_PAD_CTRL	(PAD_CTL_SPEED_HIGH | PAD_CTL_SRE | \
...
enum {
	...
	VF610_PAD_PTC26__NFC_RBB		= IOMUX_PAD(0x018c, 0x018c, 5, __NA_, 0, VF610_NFC_SIG_RB_PAD_CTRL), // Ready/Busy is an input signal with xtal PULLUP
