...
enum {
	...
	SAC58R_PAD_PH15__UART0_RX		= IOMUX_PAD(0x03bc, 0x03bc, 0, 0x0b20, 2, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PF11__UART1_TX		= IOMUX_PAD(0x02ac, 0x02ac, 1, 0x0b54, 2, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PF12__UART1_RX		= IOMUX_PAD(0x02b0, 0x02b0, 0, 0x0b28, 2, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PL5__UART2_TX		= IOMUX_PAD(0x03b8, 0x03b8, 1, 0x0b50, 2, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PL4__UART2_RX		= IOMUX_PAD(0x03bc, 0x03bc, 0, 0x0b20, 2, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PE28__UART3_TX		= IOMUX_PAD(0x0270, 0x0270, 1, 0x0b38, 2, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PE27__UART3_RX		= IOMUX_PAD(0x026c, 0x026c, 0, 0x0b5c, 2, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PH0__UART4_TX		= IOMUX_PAD(0x0380, 0x0380, 1, 0x0b60, 3, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PH1__UART4_RX		= IOMUX_PAD(0x0384, 0x0384, 0, 0x0b40, 3, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PH9__UART5_TX		= IOMUX_PAD(0x03a4, 0x03a4, 1, 0x0b64, 3, SAC58R_UART_PAD_CTRL),
	SAC58R_PAD_PH10__UART5_RX		= IOMUX_PAD(0x03a8, 0x03a8, 0, 0x0b48, 3, SAC58R_UART_PAD_CTRL),
